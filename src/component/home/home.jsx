                ...
                /> */}
                                    ...
                                    <div id='ContactUsContiner'  >
                                        ...
                                        <div id='secondPartContactUs'   >
                                            <input type='text' id='inputCOntactHome' placeholder='Full Name' value={this.state.name} onChange={(e) => {
                                                this.setState({ name: e.target.value })
                                            }} />
                                            <input type='text' id='inputCOntactHome' placeholder='E-mail' value={this.state.email} onChange={(e) => {
                                                this.setState({ email: e.target.value })
                                            }} />
                                            <textarea id='areaCOntactHome' placeholder='Message' value={this.state.text} onChange={(e) => {
                                                this.setState({ name: e.target.value })
                                            }} />
